"""Tests for notetaking.watcher — meeting detection via process monitoring."""
...
from notetaking.watcher import MEETING_PROCESSES, MeetingEvent, _is_meeting_active, watch_meetings


class TestIsMeetingActive:
    @patch("notetaking.watcher.psutil")
...
class TestWatchMeetings:
    @patch("notetaking.watcher._is_meeting_active")
    ...
    @patch("notetaking.watcher._is_meeting_active", return_value=None)
